  ...
  it("renders unchanged", async () => {
    ...
    expect(component.html()).toMatchInlineSnapshot(`
      "<div class="flex flex-col flex-1 justify-end gap-2">
        ...
        </div><a href="/r/test"><button class="btn w-full btn-sm bg-black text-white hover:bg-black/80 bg-black"> Read post <svg data-v-1a166b3b="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="icon" width="1em" height="1em" viewBox="0 0 24 24">
